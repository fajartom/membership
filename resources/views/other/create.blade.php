...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Create Other</h3></div>
        <div class="col text-right">
            
            <a class="btn btn-sm btn-primary" href="{{ route('other.index', $locale)}}">Back</a>
...
{!! Form::open(array('route' => ['other.store', $locale],'method'=>'POST')) !!}
<div class="row">
