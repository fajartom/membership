                    ...
                    <div id="processTabs" class="ui-tabs ui-corner-all ui-widget ui-widget-content">
                        ...
                        <div id="ptab1" aria-labelledby="ui-id-1" role="tabpanel"
                            ...
                            <div class="postcontent">
                                <form class="offset-lg-1" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 offset-lg-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <small id="phone_numberHelp" class="form-text text-muted">your phone
                                                    number.</small>
                                            </div>
                                            <div class="form-group">
        ...
        $("#next").click(function(e) {
            ...
            $.post("/api/register/", data,
                function(data, status) {
                    if (data.error)
                    {
                        for (let attr in data.error)
                        {
                            $(`#${attr}Help`).html(`<font color="red">${data.error[attr][0]}</font>`);
                            $(`[name=${attr}]`).css({borderColor: 'red'});
                        }
                    } else {
                        $("#processTabs").tabs("option", "active", $this.attr('rel') - 1);
