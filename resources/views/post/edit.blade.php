...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Edit Post</h3></div>
...
@endif
{!! Form::model($cat, ['method' => 'PATCH', 'route' => ['post.update', $locale, $cat->id],'files' =>true,'enctype'=>'multipart/form-data']) !!}
<div class="row">
     <div class="col-xs-12 col-sm-12 col-md-12">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
          <img class="img-fluid" src="{{asset('storage/artikel')}}/{{$cat->image}}" style="max-height: 400px">
        </div>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Category:</strong>
                   {!! Form::select('category_id', ['' => 'Please Select'] + $categories, $cat->category_id, array('class' => 'form-control','single')) !!}
        </div>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <div class="custom-control custom-checkbox mb-3">
              <input class="custom-control-input" name="member_allow[]" id="customCheck{{$key}}" type="checkbox" value="{{$v->id}}" @if (in_array($v->id, json_decode($cat->member_allow, true))) checked @endif }}>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <div class="custom-control custom-radio mb-3">
              <input class="custom-control-input" name="featured" id="customRadio{{$key}}" type="radio" value="{{$key}}" @if($cat->featured==$key) checked @endif>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Status:</strong>
                   {!! Form::select('status', ['' => 'Please Select'] + $_status, $cat->status, array('class' => 'form-control','single')) !!}
        </div>
      </div>
              <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
            <strong>Add Album:</strong>
                 {!! Form::select('album[]', $_album, json_decode($cat->album), array('class' => 'select-2 form-control', 'id'=>'album', 'multiple')) !!}
          </div>
        </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
