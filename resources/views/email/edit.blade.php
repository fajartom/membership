...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col text-right">
            ...
            <a class="btn btn-sm btn-primary" href="{{ route('email.index', $locale)}}">Back</a>
...
{!! Form::model($cat, ['method' => 'PATCH','route' => ['email.update', $locale, $cat->id]]) !!}
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Subject:</strong>
            {!! Form::text('subject', $cat->subject, array('placeholder' => 'Subject','class' => 'form-control')) !!}
        </div>
        <div class="form-group">
