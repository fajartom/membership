...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Edit</h3></div>
...
{!! Form::model($cat, ['method' => 'PATCH','route' => ['fitur.update', $locale, $cat->id]]) !!}
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            ...
            <span id="icons" style="font-size: 36px;"><i class="ni ni-{{$cat->icon}}"></i></span>
