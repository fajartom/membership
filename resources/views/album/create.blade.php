     ...
     <div class="card shadow">
      <div class="card-header border-0">
        <div class="row align-items-center">
          <div class="col"><h3 class="mb-0 text-capitalize">Create album</h3></div>
      ...
      <div class="card-body">
        ...
        @endif
        {!! Form::open(array('route' => ['album.store', $locale],'method'=>'POST','files' =>true,'enctype'=>'multipart/form-data')) !!}
        <div class="row">
