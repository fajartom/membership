...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Edit Slider</h3></div>
...
{!! Form::model($cat, ['method' => 'PATCH','route' => ['slider.update', $locale, $cat->id],'files' =>true,'enctype'=>'multipart/form-data']) !!}
...
<div class="row">
     <div class="col-xs-12 col-sm-12 col-md-6">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
            <img src="http://{{ request()->getHttpHost() }}/storage/slider/{{ $cat->image }}" width="50%">
        </div>
      </div>
