...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Create Users</h3></div>
...
{!! Form::open(array('route' => ['users.store', $locale],'method'=>'POST')) !!}
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('domain', null, array('placeholder' => 'Domain','class' => 'form-control')) !!}
        </div>
    </div>
