...
<div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
    ...
    <div class="card-header border-0">
        ...
        <div class="col"><h3 class="mb-0 text-uppercase">Create Artist</h3></div>
...
{!! Form::open(array('route' => ['artist-ngefans.store', $locale],'method'=>'POST','files' =>true,'enctype'=>'multipart/form-data')) !!}
<div class="row">
